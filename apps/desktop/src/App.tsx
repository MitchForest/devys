...
import { FileExplorer, Tabs, CodeEditor, ThemeToggle, type Tab } from '@claude-code-ide/ui';
...
function App() {
    ...
    content: (
      <div className="h-full flex flex-col">
        <div className="px-4 py-2 border-b border-border">
          <h2 className="text-xs text-muted-foreground">{file.path}</h2>
        </div>
  ...
  return (
    <div className="h-screen w-screen bg-background text-foreground flex flex-col">
        ...
        <PanelGroup direction="horizontal">
          ...
          <Panel defaultSize={showChat ? 60 : 85}>
            <PanelGroup direction="vertical">
              ...
              {showTerminal && (
                <>
                  <PanelResizeHandle className="h-px bg-border hover:bg-primary/20 transition-colors" />
      ...
      {/* Status Bar */}
      <div className="h-6 bg-panel border-t border-border flex items-center px-2 text-xs text-muted-foreground">
        <span>Ready</span>
