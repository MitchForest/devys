...
struct MetalDiffView: View {
    ...
    @State private var themeName: String = CodeViewDesign.dark.syntaxThemeName
    ...
    private func updateTheme() {
        let requestedThemeName = CodeViewDesign.resolved(for: colorScheme).syntaxThemeName
    ...
    private func rebuildLayout(width: CGFloat) {
        ...
        let metrics = EditorMetrics.measure(
