...
final class MetalDiffDocumentView: NSView, MTKViewDelegate {
    ...
    var themeName: String = CodeViewDesign.dark.syntaxThemeName
    var themeVersion: Int = ThemeRegistry.descriptor(name: CodeViewDesign.dark.syntaxThemeName).version
    ...
    override var isOpaque: Bool {
        !configuration.surfaceDesign.usesGlassBackground
    }
    ...
    func updateConfiguration(_ configuration: DiffRenderConfiguration) {
        let needsFontUpdate = configuration.fontName != self.configuration.fontName
            ...
            || configuration.lineHeight != self.configuration.lineHeight
    ...
    func applyClearColor() {
        if configuration.surfaceDesign.usesGlassBackground {
    ...
    func applySurfaceCompositing() {
        MetalSurfaceCompositing.apply(
            hostView: self,
            metalView: mtkView,
            drawsOpaqueBackground: !configuration.surfaceDesign.usesGlassBackground,
