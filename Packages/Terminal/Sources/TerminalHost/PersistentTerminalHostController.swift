...
public enum PersistentTerminalHostStartupMode: String, Sendable {
    case warm
    case cold
}

public actor PersistentTerminalHostController {
    ...
    public func ensureRunning() async throws -> PersistentTerminalHostStartupMode {
    ...
    public func listSessions() throws -> [TerminalHostedSessionRecord] {
    ...
    ) async throws -> TerminalHostedSessionRecord {
    ...
    public func terminateSession(id: UUID) throws {
