...
private let terminalColorSuppressingEnvironmentKeys = ["NO_COLOR"]

public enum TerminalSessionLaunchError: LocalizedError, Sendable {
...
public enum TerminalSessionLaunchProfile: String, Codable, Equatable, Sendable {
    case fastShell = "fast_shell"
    case compatibilityShell = "compatibility_shell"
}

public func terminalSessionEnvironmentAssignments() throws -> [String: String] {
...
public func terminalSessionTerminfoDirectory() -> String? {
...
public func terminalSessionCandidateResourceURLs(
    ...
    let explicitResourceURLs = [
        ...
        terminalSessionMacClientSourceResourceDirectory(),
    ]
...
public func terminalSessionResourceDirectory(executablePath: String?) -> URL? {
...
private func terminalSessionMacClientSourceResourceDirectory() -> URL? {
    return URL(filePath: #filePath)
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .appendingPathComponent("Apps/mac-client/Resources", isDirectory: true)
}

public func terminalSessionEnvironmentKeysToUnset() -> [String] {
    terminalColorSuppressingEnvironmentKeys
}

public func terminalSessionTermProgramVersion() -> String? {
...
public func terminalSessionColorFgBg() -> String {
...
public func resolvedTerminalShellPath(environment: [String: String]) -> String {
...
public func terminalShellLaunchConfiguration(
