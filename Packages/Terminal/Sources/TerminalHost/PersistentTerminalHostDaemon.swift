...
public final class PersistentTerminalHostDaemon: @unchecked Sendable {
    private final class HostedSession {
        let record: TerminalHostedSessionRecord
        let pid: pid_t
        let primaryFD: Int32
        ...
        init(
            record: TerminalHostedSessionRecord,
            pid: pid_t,
            primaryFD: Int32,
...
private extension PersistentTerminalHostDaemon {
    ...
    private func createSession(
        request: CreateSessionRequest
    ) throws -> TerminalHostedSessionRecord {
        ...
        let record = TerminalHostedSessionRecord(
            ...
            launchCommand: request.launchCommand,
            viewportSize: HostedTerminalViewportSize(
