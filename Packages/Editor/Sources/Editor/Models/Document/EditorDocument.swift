...
public final class EditorDocument {
    ...
    var language: String
    var diffPresentationSyntaxLanguage: String?
    ...
    public static func detectedLanguage(for url: URL) -> String {
        LanguageDetector.detect(from: url)
    }
    ...
    var syntaxLanguage: String {
        diffPresentationSyntaxLanguage ?? language
    }

    var displayLanguage: String {
        diffPresentationSyntaxLanguage == nil ? language : "diff"
    }

    public func configureDiffPresentation(syntaxLanguage: String) {
        let normalizedLanguage = syntaxLanguage.isEmpty ? "plaintext" : syntaxLanguage
        guard diffPresentationSyntaxLanguage != normalizedLanguage else { return }
        diffPresentationSyntaxLanguage = normalizedLanguage
        syntaxController = nil
        syntaxThemeName = nil
        syntaxMaximumTokenizationLineLength = nil
    }
