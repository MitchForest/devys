...
public struct EditorView: NSViewRepresentable {
    ...
    private let usesGlassBackground: Bool
    ...
    public init(url: URL) {
        ...
        self.usesGlassBackground = CodeViewDesign.surfaceDesign.usesGlassBackground
    }
    ...
    public init(
        ...
        usesGlassBackground: Bool = CodeViewDesign.surfaceDesign.usesGlassBackground
    ) {
        self.url = nil
    ...
    public func makeNSView(context: Context) -> MetalEditorView {
        ...
        view.usesGlassBackground = usesGlassBackground
    ...
    public func updateNSView(_ nsView: MetalEditorView, context: Context) {
        ...
        nsView.usesGlassBackground = usesGlassBackground
