...
public enum Colors {
    ...
    /// Window background, drawers, and gaps between panes.
    public static let darkBase = Color(hex: "#0F0F10")

    /// Split pane content areas, elevated cards
    public static let darkCard = Color(hex: "#1A1A1C")

    /// Popovers, dropdowns, command palette, modals
    public static let darkOverlay = Color(hex: "#232325")

    // MARK: - Light Mode Surfaces

    public static let lightBase = Color(hex: "#F4F4F6")
    public static let lightCard = Color(hex: "#FFFFFF")
    public static let lightOverlay = Color(hex: "#FFFFFF")

    // MARK: - Dark Mode Text

    public static let darkText = Color(hex: "#EDEDEF")
    public static let darkTextSecondary = Color(hex: "#9A9AA1")
    public static let darkTextTertiary = Color(hex: "#5A5A60")
    public static let darkTerminalText = Color(hex: "#FFFFFF")

    // MARK: - Light Mode Text

    public static let lightText = Color(hex: "#1A1A1C")
    public static let lightTextSecondary = Color(hex: "#76767C")
    public static let lightTextTertiary = Color(hex: "#AAAAB0")
    public static let lightTerminalText = Color(hex: "#000000")

    // MARK: - Borders

    public static let darkBorder = Color(hex: "#2A2A2D")
    public static let lightBorder = Color(hex: "#E2E2E5")
...
public struct Theme: Sendable {
    ...
    public var hover: Color {
        isDark ? Color(hex: "#18181A") : Color(hex: "#ECECEF")
    }

    /// Active/pressed state.
    public var active: Color {
        isDark ? Color(hex: "#222225") : Color(hex: "#E2E2E5")
    }

    /// Hover within a card context.
    public var cardHover: Color {
        isDark ? Color(hex: "#222224") : Color(hex: "#F8F8FB")
    }
    ...
    public var accentForeground: Color {
        ...
        return accentColor.isPerceptuallyLight ? Colors.darkBase : .white
    }
