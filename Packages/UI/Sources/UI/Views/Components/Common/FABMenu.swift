...
struct FABMenuSection: Sendable {
    let title: String?
    let items: [FABMenuItem]

    init(title: String? = nil, items: [FABMenuItem]) {
        self.title = title
        self.items = items
    }
}
