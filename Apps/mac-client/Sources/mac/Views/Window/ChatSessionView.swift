...
struct ChatSessionView: View {
    ...
    let session: ChatSessionRuntime
    ...
    private static let bottomSentinelID = "chat-session-bottom-sentinel"
    ...
    private func attachmentChip(_ summary: ChatAttachmentSummary) -> some View {
        HStack(spacing: Spacing.space2) {
    ...
    fileprivate var emptyStateMessage: String {
        switch session.launchState {
        case .launching:
            "Restoring the prior session and replaying chat state."
    ...
    fileprivate func attachment(from url: URL) -> ChatAttachment {
