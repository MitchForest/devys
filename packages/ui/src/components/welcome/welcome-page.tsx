    ...
    <div className="h-full w-full flex items-center justify-center bg-background">
      <div className="max-w-2xl w-full px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-2xl font-semibold mb-2">Devys</h1>
        ...
        <div className="space-y-8">
              ...
              <div className="space-y-2">
                {recentFolders.map((folder, index) => (
                  <button
                    ...
                    className="w-full text-left px-4 py-3 bg-surface-2 rounded-md hover:bg-surface-3 transition-colors group"
                  >
          ...
          <div className="text-center text-xs text-muted">
            <div className="space-y-1">
              <div>
                <kbd className="px-1.5 py-0.5 bg-surface-3 rounded text-xs">⌘O</kbd> Open Folder
              </div>
              <div>
                <kbd className="px-1.5 py-0.5 bg-surface-3 rounded text-xs">⌘T</kbd> New Terminal
              </div>
              <div>
                <kbd className="px-1.5 py-0.5 bg-surface-3 rounded text-xs">⌘⇧C</kbd> Toggle Chat
              </div>
            </div>
          </div>
        </div>
